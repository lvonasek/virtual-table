DROP TABLE %CARDS%
DROP TABLE %PLAYERS%
CREATE TABLE %CARDS% (`front` varchar(32) COLLATE utf8_unicode_ci NOT NULL,`back` varchar(32) COLLATE utf8_unicode_ci NOT NULL,`x` float NOT NULL,`y` float NOT NULL,`timestamp` bigint(20) NOT NULL,`w` float,`h` float);
